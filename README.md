...
4. **Atur izin lisensi.** Kreator menentukan harga lisensi dan apakah karya boleh dipakai untuk training AI. Semua tercatat on-chain, bisa diverifikasi siapa pun.
5. **Jual dan terima royalti.** Pembeli membayar lisensi, royalti mengalir langsung ke wallet kreator. Ada juga fitur **patungan (Trovaya Family)**: 3 sampai 5 orang bisa berbagi satu lisensi bersama.
...
- Aplikasi berjalan di **BSC Testnet**, yaitu lingkungan uji, bukan mainnet produksi.
